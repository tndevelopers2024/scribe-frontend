...
const BeTheChange = ({ isFaculty, studentId, studentData, updatePendingCount }) => {
    ...
    const confirmDelete = async () => {
        ...
        try {
            const config = { headers: { Authorization: `Bearer ${user.token}` } };
            await axios.delete(`${API_ENDPOINTS.BE_THE_CHANGE}/${itemToDelete._id}`, config);
    ...
    const handleReviewSubmit = async (status, item = null) => {
        ...
        try {
            ...
            if (updatePendingCount) {
                updatePendingCount('bethechange');
            }
    ...
    return (
        <div className="space-y-6">
                                ...
                                >
                                    ...
                                    <div className="col-span-4 flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-brand-purple/10 flex items-center justify-center text-brand-purple flex-shrink-0">
                                            <FaHeart className="text-brand-pink text-sm" />
                                        </div>
                                        <div>
                                ...
                                {expandedRows[reflection._id] && (
                                    <div className="px-6 pb-6 pt-2 bg-gray-50/50 animate-fade-in">
                                        <div className="grid grid-cols-1 gap-6 p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                                            <div>
                                                <p className="text-xs font-bold text-gray-400 uppercase mb-1">Impact Reflection</p>
                                                <p className="text-sm text-gray-700 leading-relaxed font-medium whitespace-pre-wrap">{reflection.reflectOnImpact}</p>
                                            </div>
            ...
            <DeleteConfirmationModal
                ...
                itemName="Be the Change Reflection"
